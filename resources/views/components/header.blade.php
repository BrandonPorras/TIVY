    ...
    <div class="col-lg-3 col-md-3 col-sm-5 col-5 collapse navbar-collapse " id="navbarNav">
      <div class="row col-12 d-flex justify-content-end ">
        <ul class="navbar-nav ">
          ...
          <li class="nav-item active">
            <a class="nav-link active text-dark" href="{{ route('user.show', Auth::user()) }}">@lang('Profile')</a>
          </li>
          @guest
            <li class="nav-item active">
          ...
          @auth
            <li class="nav-item active">
              <a class="nav-link active text-dark" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                {{ __('Logout') }}
              </a>
            </li>
